...
namespace Config {
    ...
    constexpr float TAP_Z_VELOCITY = 150.0f; // was 500 — fires on lighter taps
    constexpr float TAP_PALM_MAX_SPEED = 80.0f; // was 60 — palm doesn't need to be as still
    constexpr int TAP_COOLDOWN_FRAMES = 20; // was 18 — ~83ms lockout instead of 150ms
